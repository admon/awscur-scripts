...
def analyze_savings_plans(df, savings_plan_ids):
    ...
    april_start = pd.Timestamp('2025-05-01', tz=UTC)
    april_end = pd.Timestamp('2025-05-30 23:59:59.999999', tz=UTC)
    ...
    sp_df = sp_df[sp_df[savings_plan_id_col].isin(savings_plan_ids)]
